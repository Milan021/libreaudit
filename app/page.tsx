...
const CATEGORIES = [
  ...
  { id: "collectivites", label: "Collectivités Territoriales", icon: "🏘️" },
  { id: "iam", label: "Gestion des Identités & Accès (IAM)", icon: "🔐" },
...
const PROPRIETARY_DB: Record<string, any[]> = {
  ...
  collectivites: [
    { name: "Marco Web (Agysoft)", riskLevel: 3, lockIn: 4, hausse: 4.5, alternatives: [{ name: "Atexo / Klekoon", maturity: 3 }, { name: "Maximilien (plateforme mutualisée)", maturity: 4 }] },
    { name: "Mélogie (Arpège)", riskLevel: 3, lockIn: 4, hausse: 4.0, alternatives: [{ name: "e.magnus Berger-Levrault", maturity: 4 }, { name: "Solution COMEDEC native", maturity: 2 }] },
    { name: "Concerto (Arpège)", riskLevel: 3, lockIn: 4, hausse: 4.0, alternatives: [{ name: "OpenConcerto (fork)", maturity: 3 }, { name: "GLPI + portail OSS", maturity: 3 }] },
    { name: "CivilNet RH (Ciril Group)", riskLevel: 3, lockIn: 4, hausse: 5.0, alternatives: [{ name: "OrangeHRM / Odoo RH", maturity: 3 }, { name: "WeRH Berger-Levrault", maturity: 3 }] },
    { name: "CivilNet Finances (Ciril Group)", riskLevel: 3, lockIn: 4, hausse: 5.0, alternatives: [{ name: "Odoo Finance", maturity: 3 }, { name: "Chorus Pro / API DGFiP", maturity: 4 }] },
    { name: "CivilNet Élections (Ciril Group)", riskLevel: 2, lockIn: 3, hausse: 3.5, alternatives: [{ name: "e.magnus Élections (BL)", maturity: 4 }, { name: "Solutions mutualisées", maturity: 3 }] },
    { name: "Kelio (Berger-Levrault)", riskLevel: 3, lockIn: 3, hausse: 4.5, alternatives: [{ name: "Badgeuse OSS + Odoo HR", maturity: 3 }, { name: "TimeTonic", maturity: 3 }] },
  ],
  iam: [
    { name: "Microsoft Entra ID (ex-Azure AD)", riskLevel: 4, lockIn: 5, hausse: 5.5, alternatives: [{ name: "Keycloak", maturity: 5 }, { name: "FreeIPA", maturity: 4 }] },
    { name: "Okta (IAM / SSO)", riskLevel: 3, lockIn: 4, hausse: 6.0, alternatives: [{ name: "Keycloak", maturity: 5 }, { name: "Authentik", maturity: 4 }, { name: "Gluu / Janssen", maturity: 3 }] },
    { name: "Ping Identity (PingFederate / PingOne)", riskLevel: 3, lockIn: 4, hausse: 5.0, alternatives: [{ name: "Keycloak", maturity: 5 }, { name: "WSO2 Identity Server", maturity: 3 }] },
    { name: "CyberArk (PAM)", riskLevel: 4, lockIn: 4, hausse: 5.5, alternatives: [{ name: "Teleport", maturity: 4 }, { name: "HashiCorp Boundary", maturity: 3 }] },
    { name: "SailPoint IdentityNow (IGA)", riskLevel: 3, lockIn: 4, hausse: 6.0, alternatives: [{ name: "midPoint (IGA)", maturity: 4 }, { name: "OpenIAM", maturity: 3 }] },
    { name: "IBM Security Verify", riskLevel: 3, lockIn: 4, hausse: 4.5, alternatives: [{ name: "Keycloak", maturity: 5 }, { name: "FreeIPA", maturity: 4 }] },
    { name: "ForgeRock (OpenAM → Ping)", riskLevel: 3, lockIn: 4, hausse: 5.5, alternatives: [{ name: "Keycloak", maturity: 5 }, { name: "Authentik", maturity: 4 }] },
    { name: "Keycloak (Red Hat / open source)", riskLevel: 1, lockIn: 2, hausse: 0.0, alternatives: [{ name: "Authentik", maturity: 4 }, { name: "Gluu / Janssen", maturity: 3 }] },
    { name: "Authentik (open source)", riskLevel: 1, lockIn: 1, hausse: 0.0, alternatives: [{ name: "Keycloak", maturity: 5 }, { name: "FreeIPA", maturity: 4 }] },
  ],
  finance: [
  ...
  grc: [
    { name: "Cyberdashboard (Limon IT)", riskLevel: 2, lockIn: 3, hausse: 6.0, alternatives: [{ name: "Grafana + Wazuh", maturity: 4 }, { name: "Eramba", maturity: 4 }, { name: "Pilar (EBIOS RM)", maturity: 3 }] },
    { name: "Board of Cyber (Security Rating)", riskLevel: 2, lockIn: 3, hausse: 8.0, alternatives: [{ name: "OpenVAS / Greenbone", maturity: 3 }, { name: "CISO Assistant", maturity: 3 }] },
    { name: "Cyber Pilot (Ad Confirma)", riskLevel: 2, lockIn: 3, hausse: 7.0, alternatives: [{ name: "Tenacy", maturity: 4 }, { name: "Eramba", maturity: 4 }] },
    { name: "Tenacy (GRC cyber FR)", riskLevel: 2, lockIn: 3, hausse: 7.0, alternatives: [{ name: "Eramba", maturity: 4 }, { name: "Pilar (EBIOS RM)", maturity: 3 }] },
    { name: "Egerie (Risk Manager FR)", riskLevel: 2, lockIn: 3, hausse: 6.0, alternatives: [{ name: "Pilar (EBIOS RM)", maturity: 4 }, { name: "CISO Assistant", maturity: 3 }] },
